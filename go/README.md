...
```bash
go get github.com/aplane-algo/aplane-sdks/go
```
...
import (
	...
	"github.com/aplane-algo/aplane-sdks/go"
)
...
| `htlc-v*` | Hash-locked funds | Requires `preimage` arg |
...
- Repository: https://github.com/aplane-algo/aplane-sdks
- SDK path: `go`

APlane is an open-source project stewarded by the APlane Project.

See the repository [README](https://github.com/aplane-algo/aplane-sdks/blob/main/README.md) for project overview and alpha-status guidance, and [DISCLAIMER.md](https://github.com/aplane-algo/aplane-sdks/blob/main/DISCLAIMER.md) for risk, liability, and usage information.
